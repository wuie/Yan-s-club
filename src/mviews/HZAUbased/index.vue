<template>
  <div class="hzauBasedContainer">
    <div class="researchBox">
      <div class="HzauBasedHeader">Research</div>
      <el-divider />
      ...
      <div class="hzauImages">
        <ul style="display: flex;flex-direction: row;justify-content: space-around;flex-wrap: wrap;padding: 0%;margin: 0%;">
          <li v-for="i in srcList" style="padding:0% 0% 1vh 0%;margin: 0%;list-style: none;width: 45%;display: flex;flex-direction: row;justify-content: space-around;flex-wrap: wrap;">
            <el-image
    ...
    <div class="teamBox">
      <div class="HzauBasedHeader">Team</div>
      <el-divider />
...
// 接口函数
import { getResearchListApi,getPictListApi } from "@/api/HZAU-based/research.js";
import {
...
function toAluminPage() {
  router.push({ path: "/index/alumin", query: { kind: "HZAU" } });
}
